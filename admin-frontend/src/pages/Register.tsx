...
export const Register = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setError('Не удалось зарегистрироваться. Возможно, этот email уже занят.');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
          <div className="mb-4 sm:mb-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Создать аккаунт</h2>
          ...
          <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1 sm:mb-1.5">
                Подтвердите пароль
              </label>
              <input
                id="confirm-password"
